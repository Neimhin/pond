...
if main():
    ...
    for index in [0,1,2,3]:
        ...
        plt.plot(np.arange(y_only.shape[0]),y_only,color="black",label="true target values")
        ...
        plt.title(f"n= {days_ahead[index]} Days Ahead Prediction for Each Day vs Target Value")
        plt.legend()
        plt.show() 
